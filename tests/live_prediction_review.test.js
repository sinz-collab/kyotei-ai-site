...
assert.match(
  appSource,
  /currentPredictionAvailable && !\["tokoname", "toda", "wakamatsu"\]\.includes\(currentVenueSlug\)/,
  "Tokoname, Toda, and Wakamatsu must not use the browser-side live prediction review",
);
